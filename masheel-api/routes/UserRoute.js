...
const { invalidUser, invalidUserLogin } = require("../utils/Validate");
 ...
 * @param {Object} req has to be a json object of the form described in @method User.createUserBasic or @method User.createUserDetailed .
 * @return {String}
 */
